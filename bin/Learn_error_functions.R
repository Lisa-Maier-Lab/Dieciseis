...
# Originally collected by https://github.com/ErnakovichLab/dada2_ernakovichlab

# **Option 1**  alter loess arguments (weights and span and enforce monotonicity)
...
# Originally recommended in: https://github.com/benjjneb/dada2/issues/791
...
# From Jonalim’s comment in https://github.com/benjjneb/dada2/issues/1307
